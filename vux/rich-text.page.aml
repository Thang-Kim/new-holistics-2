Dashboard rich_text_demo {
  title: 'Rich Text'
  description: ''''''
  block v4: VizBlock {
    label: 'Name and Parent'
    viz: DataTable {
...
<div class="record-details">
  ...
  block t_8699: TextBlock {
    content: @md **Largest Cart Abandonment**: *See chart* 👉

**High Conversion Rate**: *See chart* 👉
  ...
  block v_93o5: VizBlock {
    ...
    viz: MarkdownViz {
      ...
      rows: [
        ...
        VizFieldFull {
          ref: r(products.product_image_url)
          format {
            type: 'text'
          }
        },
...
<div class="insights-container">
  ...
  view: TabLayout {
    ...
    tab tab_sf0p: CanvasLayout {
      ...
      block v4 {
        position: pos(20, 20, 780, 360)
        layer: 2
      }
      block v_x1m6 {
        position: pos(20, 400, 780, 380)
        layer: 1
      }
      mobile {
        mode: 'auto'
